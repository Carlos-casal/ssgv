...
class SeedServicesCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $materials = [
            ...
            ['name' => 'Guedel Talla 0', 'category' => 'Sanitario', 'nature' => Material::NATURE_CONSUMABLE],
            ['name' => 'Guedel Talla 1', 'category' => 'Sanitario', 'nature' => Material::NATURE_CONSUMABLE],
            ['name' => 'Guedel Talla 2', 'category' => 'Sanitario', 'nature' => Material::NATURE_CONSUMABLE],
            ['name' => 'Guedel Talla 3', 'category' => 'Sanitario', 'nature' => Material::NATURE_CONSUMABLE],
            ['name' => 'Guedel Talla 5', 'category' => 'Sanitario', 'nature' => Material::NATURE_CONSUMABLE],
        ...
        if (!$template) {
            ...
            $kitItems = [
                ...
                ['name' => 'Guedel Talla 0', 'qty' => 1],
                ['name' => 'Guedel Talla 1', 'qty' => 1],
                ['name' => 'Guedel Talla 2', 'qty' => 1],
                ['name' => 'Guedel Talla 3', 'qty' => 1],
                ['name' => 'Guedel Talla 5', 'qty' => 1],
