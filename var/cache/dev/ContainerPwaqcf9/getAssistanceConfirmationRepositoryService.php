 ...
 */
class getAssistanceConfirmationRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AssistanceConfirmationRepository' shared autowired service.
     *
     * @return \App\Repository\AssistanceConfirmationRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AssistanceConfirmationRepository.php';

        return $container->privates['App\\Repository\\AssistanceConfirmationRepository'] = new \App\Repository\AssistanceConfirmationRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
