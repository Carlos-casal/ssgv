 ...
 */
class getVolunteerServiceRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\VolunteerServiceRepository' shared autowired service.
     *
     * @return \App\Repository\VolunteerServiceRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'VolunteerServiceRepository.php';

        return $container->privates['App\\Repository\\VolunteerServiceRepository'] = new \App\Repository\VolunteerServiceRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
