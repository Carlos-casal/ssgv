...
class __TwigTemplate_29630d5b7f23506f55dd4ce455f2e841 extends Template
{
    ...
    <div class=\"flex items-center justify-between\">
        ...
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 31, $this->source); })()), "user", [], "any", false, false, false, 31), "email", [], "any", false, false, false, 31), "html", null, true);
        yield "</p>
                </div>
    ...
    {
        return array (  107 => 4,  86 => 31,  59 => 6,  54 => 4,  49 => 1,);
    }

    public function getSourceContext(): Source
    {
        return new Source("<header class=\"bg-white shadow-sm border-b border-gray-200 px-6 py-4\">
    <div class=\"flex items-center justify-between\">
        <div>
...
</header>", "layout/header.html.twig", "C:\\xampp\\htdocs\\gesion_volunratios\\templates\\layout\\header.html.twig");
    }
}
