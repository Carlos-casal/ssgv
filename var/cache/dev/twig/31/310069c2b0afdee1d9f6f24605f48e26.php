...
class __TwigTemplate_d475728725b748455f55dd51fd7e35e9 extends Template
{
    ...
    public function block_body(array $context, array $blocks = []): iterable
    {
        ...
        // line 119
        yield "                ";
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["serviceForm"]) || array_key_exists("serviceForm", $context) ? $context["serviceForm"] : (function () { throw new RuntimeError('Variable "serviceForm" does not exist.', 119, $this->source); })()), "description", [], "any", false, false, false, 119), 'label', ["label_attr" => ["class" => "block text-gray-700 text-sm font-bold mb-2"], "label" => "Descripción:"]);
        yield "
                ";
        // line 120
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["serviceForm"]) || array_key_exists("serviceForm", $context) ? $context["serviceForm"] : (function () { throw new RuntimeError('Variable "serviceForm" does not exist.', 120, $this->source); })()), "description", [], "any", false, false, false, 120), 'widget', ["attr" => ["class" => "shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline h-32 resize-y"]]);
        yield " ";
        // line 121
        yield "                ";
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["serviceForm"]) || array_key_exists("serviceForm", $context) ? $context["serviceForm"] : (function () { throw new RuntimeError('Variable "serviceForm" does not exist.', 121, $this->source); })()), "description", [], "any", false, false, false, 121), 'errors', ["attr" => ["class" => "text-red-500 text-xs italic mt-1"]]);
        yield "
            </div>
        ...
        // line 125
        yield "            ";
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock((isset($context["serviceForm"]) || array_key_exists("serviceForm", $context) ? $context["serviceForm"] : (function () { throw new RuntimeError('Variable "serviceForm" does not exist.', 125, $this->source); })()), 'rest');
        yield "
        ...
        yield "\" class=\"bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline ml-3\">
            ...
            ";
        // line 137
        yield         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["serviceForm"]) || array_key_exists("serviceForm", $context) ? $context["serviceForm"] : (function () { throw new RuntimeError('Variable "serviceForm" does not exist.', 137, $this->source); })()), 'form_end');
        yield "
        </div>
    </div>
";
...
{% endblock %}", "service/new_service.html.twig", "C:\\xampp\\htdocs\\gesion_volunratios\\templates\\service\\new_service.html.twig");
    }
}
