...
final class Version20260603162000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE assistance_confirmation (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, service_id INTEGER NOT NULL, volunteer_id INTEGER NOT NULL, assigned_vehicle_id INTEGER DEFAULT NULL, status VARCHAR(255) DEFAULT \'not_attending\' NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, is_fichaje_responsible BOOLEAN DEFAULT 0 NOT NULL, justification CLOB DEFAULT NULL, vehicle_role VARCHAR(50) DEFAULT NULL, CONSTRAINT FK_A3E138BED5CA9E6 FOREIGN KEY (service_id) REFERENCES service (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_A3E138B8EFAB6B1 FOREIGN KEY (volunteer_id) REFERENCES volunteer (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_A3E138B6CF274A0 FOREIGN KEY (assigned_vehicle_id) REFERENCES vehicle (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE assistance_confirmation ADD COLUMN is_sanitario BOOLEAN DEFAULT 0 NOT NULL');
        $this->addSql('ALTER TABLE assistance_confirmation ADD COLUMN is_socorrista BOOLEAN DEFAULT 0 NOT NULL');
        $this->addSql('ALTER TABLE assistance_confirmation ADD COLUMN is_conductor BOOLEAN DEFAULT 0 NOT NULL');
    }
}
