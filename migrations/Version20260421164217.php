 ...
 */
final class Version20260421164217 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE material_unit DROP INDEX UNIQ_88D3616630FAD39E, ADD INDEX IDX_88D3616630FAD39E (kit_location_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE material_unit DROP INDEX IDX_88D3616630FAD39E, ADD UNIQUE INDEX UNIQ_88D3616630FAD39E (kit_location_id)');
