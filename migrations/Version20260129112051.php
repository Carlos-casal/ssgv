 ...
 */
final class Version20260129112051 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE maestro_material (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL, category VARCHAR(50) NOT NULL)');
        $this->addSql('CREATE TABLE service (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, type_id INTEGER DEFAULT NULL, category_id INTEGER DEFAULT NULL, numeration VARCHAR(255) DEFAULT NULL, title VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, start_date DATETIME NOT NULL, end_date DATETIME NOT NULL, registration_limit_date DATETIME DEFAULT NULL, time_at_base TIME DEFAULT NULL, departure_time TIME DEFAULT NULL, max_attendees INTEGER DEFAULT NULL, description CLOB DEFAULT NULL, recipients CLOB DEFAULT NULL --(DC2Type:json)
        ...
        $this->addSql('CREATE TABLE service_vehicle (service_id INTEGER NOT NULL, vehicle_id INTEGER NOT NULL, PRIMARY KEY(service_id, vehicle_id), CONSTRAINT FK_D404B61AED5CA9E6 FOREIGN KEY (service_id) REFERENCES service (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_D404B61A545317D1 FOREIGN KEY (vehicle_id) REFERENCES vehicle (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('CREATE INDEX IDX_D404B61AED5CA9E6 ON service_vehicle (service_id)');
        $this->addSql('CREATE INDEX IDX_D404B61A545317D1 ON service_vehicle (vehicle_id)');
        $this->addSql('CREATE TABLE service_category (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL)');
        ...
        $this->addSql('CREATE TABLE service_type (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL)');
