 ...
 */
final class Version20260423184950 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX unique_stock ON material_stock (material_id, location_id, batch_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX unique_stock ON material_stock');
